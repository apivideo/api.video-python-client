...
with apivideo.AuthenticatedApiClient(__API_KEY__) as api_client:
    ...
    try:
        # Retrieve metrics in a breakdown of dimensions
        api_response = api_instance.get_metrics_breakdown(metric, breakdown, _from=_from, to=to, sort_by=sort_by, sort_order=sort_order, filter_by=filter_by, current_page=current_page, page_size=page_size)
        pprint(api_response)
    except apivideo.ApiException as e:
        print("Exception when calling AnalyticsApi->get_metrics_breakdown: %s\n" % e)
```
...
with apivideo.AuthenticatedApiClient(__API_KEY__) as api_client:
    ...
    try:
        # Retrieve metrics over time
        api_response = api_instance.get_metrics_over_time(metric, _from=_from, to=to, interval=interval, sort_by=sort_by, sort_order=sort_order, filter_by=filter_by, current_page=current_page, page_size=page_size)
        pprint(api_response)
    except apivideo.ApiException as e:
        print("Exception when calling AnalyticsApi->get_metrics_over_time: %s\n" % e)
```
