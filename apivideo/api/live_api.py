...
class LiveApi(_EndPoint):
    ...
    def update(
            ...
            **kwargs
            ...
            >>> thread = api.update(live_stream_id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                live_stream_update_payload (LiveStreamUpdatePayload): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
    ...
    def create(
            ...
            **kwargs
            ...
            Keyword Args:
                live_stream_create_payload (LiveStreamCreatePayload): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
