...
class LiveStreamCreationPayload(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            restreams ([RestreamsRequestObject]): Use this parameter to add, edit, or remove `RTMPS` or `RTMP` services where you want to restream a live stream. The list can only contain up to 5 destinations.. [optional]  # noqa: E501
        """
